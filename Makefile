...
#    Updated: 2023/08/19 16:12:37 by smatsuo          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCDIR		=	./src
MSRCS		:=	./src/array/int_arr.c ./src/array/str_arr.c ./src/error/error.c ./src/op_list/op_list.c \
...
MOBJS		:=	$(MSRCS:.c=.o) ./src/main.o
LIBDIR		=	./libs
LIBARC		=	$(LIBDIR)/libft/libft.a $(LIBDIR)/ft_printf/libftprintf.a
INCLUDEDIR	=	./includes $(LIBDIR)/ft_printf/includes $(LIBDIR)/libft $(LIBDIR)/gnl
INCLUDES	=	$(addprefix -I ,$(INCLUDEDIR))

BONUS_NAME	=	checker
BSRCS		=	./src/checker/main.c $(LIBDIR)/gnl/get_next_line_bonus.c $(LIBDIR)/gnl/get_next_line_utils_bonus.c 
BOBJS		=	$(BSRCS:.c=.o) $(MSRCS:.c=.o)
...
$(BONUS_NAME): $(BOBJS) $(LIBARC)
	$(CC) -o $(BONUS_NAME) $(CFLAGS) $(LFLAGS) $(INCLUDES) $(BOBJS)
